    ...
    */
	...
	'connections' => [
		...
		'cash_vero' => [
			...
			'host' => env('DB_HOST', '127.0.0.1'),
			'port' => env('DB_PORT', '3306'),
			'database' => env('DB_DATABASE_CASH_VERO', 'cash-vero'),
			'username' => env('DB_USERNAME', 'forge'),
			'password' => env('DB_PASSWORD', ''),
			'unix_socket' => env('DB_SOCKET', ''),
			'charset' => 'utf8mb4',
		...
		/**
		 * Local sibling DB for company cutover from system.veroanalysis.com.
		 * Defaults to DB name "veroanalysis" on the same host as mysql.
		 * Do not point this at remote production — use mysql_production for that.
		 */
		'mysql_source' => [
			'driver' => 'mysql',
			'url' => null,
			...
			'database' => env('DB_DATABASE_SOURCE', 'veroanalysis'),
			'username' => env('DB_USERNAME_SOURCE', env('DB_USERNAME', 'forge')),
