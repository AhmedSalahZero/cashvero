...
CREATE TRIGGER `insert_net_invoice_amount_for_customers` BEFORE INSERT
	...
	set new.net_balance = CAST(ROUND(@totalInvoiceAmount - ifnull(new.total_withhold_amount,0) - ifnull(new.total_collected_amount,0) - new.total_deductions, 2) AS DECIMAL(14,2));
