...
class Settlement extends Model
{
	 ...
	 * InternalMoneyTransfer, BuyOrSellCurrency, ...). Added per request,
	 * 2026-08-13, alongside settleAdvanceWithInvoices() now persisting
	 * failures onto individual settlement rows instead of only
	 * flashing a one-time error message.
	 */
