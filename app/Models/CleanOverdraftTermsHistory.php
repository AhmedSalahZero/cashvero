...
/**
 * One dated "chapter" of a Clean Overdraft's terms — either the facility's
 * original contract (is_original = true), or a later renewal.
 *
 * @property int $id
 ...
 */
class CleanOverdraftTermsHistory extends Model
{
    ...
    public function cleanOverdraft(): BelongsTo
    {
