...
class OpeningBalancesController
{
    ...
    {
        /**
         * * ⚠️ زي update : المركز الافتتاحي لازم يتكتب كامل أو ما يتكتبش .
         */
    ...
    {
        /**
         * * ⚠️ الرصيد الافتتاحي هو نقطة البداية اللي كل كشف بعده مبني عليها .
         * * التعديل هنا بيكتب في أكتر من جدول ، فنص كتابة معناها مركز
         * * افتتاحي نُصّه قديم و نُصّه جديد — و كل الكشوف بعده غلط .
         */
        return DB::transaction(function () use ($company, $request, $openingBalance) {
