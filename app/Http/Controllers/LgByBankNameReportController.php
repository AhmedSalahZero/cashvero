...
class LgByBankNameReportController
{
    ...
    public function result(Company $company, Request $request)
    {
        ...
        return \Inertia\Inertia::render('Statements/LgByBankName/Result', [
            ...
            'urls' => [
                ...
                'printUrl' => route('print.lg.by.bank.name.report', array_merge(['company' => $company->id], $request->only([
                    'start_date', 'currency_name', 'bank_id', 'status',
                ]))),
            ],
        ]);
    ...
    private function reportPayload(Company $company, Request $request)
    {
        ...
        return [$headings, $rows, ['LG-By-Bank-Name', strtoupper((string) $data['currency'])], null];
    }
