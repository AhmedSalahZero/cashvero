 ...
 *
 * * العقد العادي بيتعلّق بأوامر بيع/شراء، وكل أمر بيتوزّع على مراحل
 * * التنفيذ بتاعته: كل مرحلة بتنزل في تاريخ نهايتها + أيام التحصيل،
 * * بحصّتها هي من قيمة الأمر.
 * *
 * * ⚠️ الوصف ده اتغيّر (2026-09). قبل كده الأمر كله كان بينزل دفعة
 * * واحدة في تاريخ نهاية آخر مرحلة — وده كان باج في
 * * applyForecastedOrderBalance() مش تصميم، و هو نفسه السبب اللي
 * * الكلاس ده اتعمل عشانه. الفرق الحقيقي اللي فاضل بين النوعين إن
 * * العقد بتنفيذ شهري **ماعندهوش أوامر أصلاً**، فمفيش مراحل يتوزّع
 * * عليها و بيتقسّم على شهوره بدلها.
 *
