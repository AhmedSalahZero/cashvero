...
@endsection
@section('content')
<div class="money-flow-dark" id="factoring-charges-statement-form"
    data-currencies-url="{{ url(app()->getLocale() . '/' . $company->id . '/factoring-charges-statement/currencies') }}"
    data-contracts-url="{{ url(app()->getLocale() . '/' . $company->id . '/factoring-charges-statement/contracts') }}">
<div class="row">
    <div class="col-md-12">
        <x-factoring-statement-tabs :company="$company" active="charges" />
        <form class="kt-form kt-form--label-right" method="get" action="{{ route('result.factoring.charges.statement', ['company' => $company->id]) }}">
                ...
                <div class="kt-portlet__body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 mb-4">
                            <label>{{ __('Factoring Contract') }}</label>
                            <select name="factoring_contract_id" id="factoring-contract-id" class="form-control kt_bootstrap_select" data-live-search="true">
...
<script src="{{ url('custom/factoring-charges-statement.js') }}?v={{ time() }}"></script>
@endsection
