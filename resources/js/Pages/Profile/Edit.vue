...
<template>
    <AppLayout>
        <div class="p-6 max-w-3xl mx-auto">
            <h1 class="text-xl font-semibold cvr-text-primary mb-6">{{ $t('My Profile') }}</h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="cvr-card-bg cvr-border border rounded-lg p-5">
                    ...
                    <div class="cvr-form-grid-2">
                        ...
                        <div>
                            ...
                            <img v-if="avatarPreview" :src="avatarPreview" class="w-20 h-20 object-cover rounded-full mb-2" :alt="$t('current avatar')" />
                ...
                <div v-if="hasOdooCredentials" class="cvr-card-bg cvr-border border rounded-lg p-5">
                    <h2 class="text-sm font-semibold cvr-text-secondary uppercase tracking-wide mb-4">{{ $t('Odoo Credentials') }}</h2>
                    <div class="cvr-form-grid-2">
                        <div>
                            <label class="cvr-form-label">{{ $t('Odoo User Name') }}</label>
                        ...
                        <div>
                            <label class="cvr-form-label">{{ $t('Odoo Database Password / API Key') }}</label>
