        ...
        <div class="p-6">
            <div class="flex items-center gap-3 mb-1">
                <Link :href="backUrl" class="cvr-btn-secondary inline-flex items-center gap-1 px-3 py-1.5 rounded border text-sm">
                    {{ $t('← Back To Loan Schedule') }}
                </Link>
            </div>
            <h1 class="text-xl font-semibold cvr-text-primary mb-6">{{ $t('Loan Schedule Payment') }}</h1>

            <form @submit.prevent="submit" class="space-y-6">
                <!-- Read-only installment info -->
                <div class="cvr-card">
                    <h2 class="text-sm font-semibold cvr-text-secondary uppercase tracking-wide mb-4">{{ $t('Loan Schedule Payment') }}</h2>
                    <div class="cvr-form-grid-3 mb-3">
                        <div>
                            <label class="cvr-form-label">{{ $t('Loan Name') }}</label>
                        ...
                        <div>
                            <label class="cvr-form-label">{{ $t('Schedule Payment') }}</label>
                    ...
                    <div class="cvr-form-grid-4 items-end">
                        ...
                        <div class="flex gap-2">
                            ...
                            <Link :href="backUrl" class="cvr-btn-secondary px-4 py-2 rounded border">{{ $t('Back To Loan Schedule') }}</Link>
                        </div>
                    </div>
                </div>
            </form>
