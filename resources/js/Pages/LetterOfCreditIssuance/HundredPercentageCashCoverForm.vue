    ...
    <AppLayout :nav-urls="navUrls">
        <div class="p-6">
            ...
            <h1 class="text-xl font-semibold cvr-text-primary mb-1">
                {{ isEdit ? 'Edit' : 'Add' }} LC Issuance — 100% Cash Cover
            </h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="cvr-card">
                    ...
                    <div class="cvr-form-grid-3">
                        ...
                        <div>
                            <label class="cvr-form-label">Deducted From Account # (Cover &amp; Commission) *</label>
                            ...
                            <p class="text-xs cvr-text-muted mt-1">Filtered by Account Type and LC Cash Cover Currency above</p>
                        </div>
                        <div>
                            <label class="cvr-form-label">
                                Balance <span v-if="accountBalanceDate">[ {{ accountBalanceDate }} ]</span>
                                <span v-if="balanceLoading" class="font-normal normal-case">(updating...)</span>
                            </label>
                            <input disabled :value="accountBalance" class="cvr-input w-full px-3 py-2 rounded opacity-70" />
                        </div>
                        <div>
                            <label class="cvr-form-label">
                                Net Balance <span v-if="accountNetBalanceDate">[ {{ accountNetBalanceDate }} ]</span>
                            </label>
