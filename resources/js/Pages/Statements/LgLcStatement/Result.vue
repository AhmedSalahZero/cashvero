                    ...
                    <table class="min-w-full text-sm">
                        <thead class="cvr-table-head sticky top-0 z-10">
                            <tr>
                                ...
                                <th v-if="isLcOverdraftBankStatement" class="px-3 py-3 text-right">Limit</th>
                                ...
                                <th v-if="isLcOverdraftBankStatement" class="px-3 py-3 text-right">Room</th>
                        ...
                        <tbody>
                            ...
                            <tr v-if="rows.length === 0">
                                <td colspan="9" class="px-4 py-8 text-center cvr-text-muted">No movements found for this date range.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
