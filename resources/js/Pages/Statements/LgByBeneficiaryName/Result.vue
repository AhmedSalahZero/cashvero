...
// are fully defined by status alone (see LgByBeneficiaryNameReportController).
                    ...
                    <table class="min-w-full text-sm">
                        ...
                        <tbody>
                            <tr v-for="(row, index) in rows" :key="row.id" class="cvr-table-row">
                                ...
                                <td class="px-3 py-2.5 text-start cvr-text-primary">{{ row.partnerName }}</td>
                                ...
                                <td class="px-3 py-2.5 text-start cvr-text-secondary">{{ row.financialInstitutionName }}</td>
