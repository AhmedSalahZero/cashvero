...
<template>
    <AppLayout>
        <div class="p-6 max-w-7xl">
            <h1 class="text-xl font-semibold cvr-text-primary mb-1">Factoring Charges Statement</h1>
            <p class="text-sm cvr-text-muted mb-4">
                Every factoring charge (interest, other charges, uncollected invoice charges), with a running total.
            </p>
                ...
                <div class="cvr-form-grid-3">
                    ...
                    <div>
                        ...
                        <select v-model="factoringContractId" class="cvr-input w-full px-3 py-2 rounded" :disabled="loadingContracts">
                            <option value="">{{ loadingContracts ? 'Loading…' : 'All Contracts' }}</option>
