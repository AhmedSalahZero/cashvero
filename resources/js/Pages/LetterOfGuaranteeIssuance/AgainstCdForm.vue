    ...
    <AppLayout :nav-urls="navUrls">
        <div class="p-6">
            ...
            <h1 class="text-xl font-semibold cvr-text-primary mb-1">
                {{ isEdit ? 'Edit' : 'Add' }} LG Issuance — Against CD
            </h1>
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="cvr-card">
                    ...
                    <div class="cvr-form-grid-4">
                        ...
                        <div>
                            <label class="cvr-form-label">CD Account #</label>
                        ...
                        <div>
                            ...
                            <p class="text-xs cvr-text-muted mt-1">Already committed against this CD</p>
                        </div>
                        <div>
