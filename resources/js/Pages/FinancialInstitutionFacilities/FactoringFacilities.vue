...
<template>
    <AppLayout>
        <div class="p-6">
            <h1 class="text-xl font-semibold cvr-text-primary mb-1">Factoring Facilities</h1>
            ...
            <p class="text-xs cvr-text-muted mb-6">
                Note: factoring contracts have no name field in this system — "Contract Name" below shows the Recourse Type (With/Without Recourse) instead, the same identifier already used on the Factoring Contracts page.
            </p>

            <div class="flex items-center justify-between mb-4 flex-wrap gap-3">
                <div class="cvr-search-bar flex items-center gap-2 px-3 py-1.5 w-72">
                    <span class="cvr-text-muted text-sm">🔍</span>
                    <input v-model="search" type="text" placeholder="Search by factoring company or contract..." class="bg-transparent outline-none text-sm w-full cvr-text-primary" />
                </div>
            </div>
                ...
                <table class="min-w-full text-sm">
                    <thead class="cvr-table-head">
                        <tr>
                            ...
                            <th class="px-3 py-3 text-left">Factoring Company Name</th>
