    ...
    <AppLayout>
        <div class="p-6">
            <div class="flex items-center justify-between mb-1 flex-wrap gap-3">
                <div>
                    <h1 class="text-xl font-semibold cvr-text-primary mb-1">{{ $t('Suppliers Opening Balance') }}</h1>
                    <p class="text-sm cvr-text-muted">{{ $t('Opening invoices and advanced down payments for this company\'s suppliers') }}</p>
                </div>
            ...
            <div v-if="!exists" class="cvr-card mt-8 text-center py-12">
                ...
                <p class="text-sm cvr-text-muted mb-5">{{ $t('Set the starting invoices and down payments for this company\'s suppliers.') }}</p>
                <a :href="manageUrl" class="cvr-btn-copper inline-flex items-center gap-1 px-4 py-2 rounded-lg text-sm font-medium">
