 ...
 * — matches the exact rule used by
 * UpdateCurrentAccountBasedOnCurrencyController@index on the old
 * jQuery version of this form.
 */
...
/* ── Auto-calculate Interest Amount [At Maturity] ────────────────
   Mirrors the old page's recalculate-interest-amount script:
   rate/100/365 * days-between-dates * amount */
    ...
    <AppLayout :nav-urls="navUrls">
        <div class="p-6">
            ...
            <h1 class="text-xl font-semibold cvr-text-primary mb-1">
                {{ isEdit ? $t('Edit') : $t('Add') }} {{ $t('Time Of Deposit') }}
            </h1>
                ...
                <div class="cvr-card">
                    ...
                    <div class="cvr-form-grid-3">
                        ...
                        <div v-if="hasOdooIntegration">
                            ...
                            <p v-if="errorFor('odoo_code')" class="text-xs mt-1 cvr-num-red">{{ errorFor('odoo_code') }}</p>
                        </div>
