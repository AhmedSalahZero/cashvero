      ...
      <form
        ...
        <div class="space-y-3">
          <div
            ...
            :key="group.key"
            class="cvr-card overflow-hidden">
                  ...
                  <td class="px-4 py-3">
                    <div class="flex flex-wrap gap-x-6 gap-y-2">
                      <label
                        ...
                        :class="
                          canToggle(perm.key) ? 'cursor-pointer' : 'opacity-50 cursor-not-allowed'
                        "
                        :title="
                          canToggle(perm.key)
                            ? perm.key
                            : `You cannot grant ${perm.key} — you do not hold it yourself.`
                        ">
                        <input
                          type="checkbox"
