                ...
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        <tr v-for="(invoice, i) in rows" :key="invoice.id" class="cvr-table-row">
                            ...
                            <td class="px-4 py-3 text-center">
                                <!-- Always available: a settled invoice still
                                     has to expose the deductions already saved
                                     on it, so they can be reviewed and edited.
                                     What may be deducted is enforced server
                                     side (UpdateInvoiceDeductionRequest), which
                                     adds the saved deductions back before
                                     comparing - so re-saving them is fine while
                                     deducting beyond the balance is not. -->
