(function ($) {
    const root = $('#factoring-charges-statement-form');
    ...
    function loadCurrencies() {
        ...
        if (!companyId) {
            ...
            rebuildSelect($contract, [], 'id', 'label', 'All Contracts');
            return;
        }
    ...
    function loadContracts() {
        ...
        $.get(contractsBaseUrl + '/' + companyId + '/' + currency, {
            ...
            rebuildSelect($contract, response.contracts || [], 'id', 'label', 'All Contracts');
        });
    }
