...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `reverse_overdraft_against_contract`(in _start_update_from_date date  , in _overdraft_against_assignment_of_contract_id integer )
begin 
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS reverse_overdraft_against_contract");
    }
};
