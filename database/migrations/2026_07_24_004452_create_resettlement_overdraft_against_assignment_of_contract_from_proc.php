...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE DEFINER=`root`@`localhost` PROCEDURE `resettlement_overdraft_against_assignment_of_contract_from`(in _type varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci, in _overdraft_against_assignment_of_contract_id integer , in _current_company_id integer  )
begin 
