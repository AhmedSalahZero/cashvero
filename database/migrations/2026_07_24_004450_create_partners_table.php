...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('partners', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->integer('due_to_chart_of_account_number_odoo_code')->nullable();
            $table->integer('due_to_chart_of_account_number_odoo_id')->nullable();
            $table->integer('due_from_chart_of_account_number_odoo_code')->nullable();
            $table->integer('due_from_chart_of_account_number_odoo_id')->nullable();
        });
    }
