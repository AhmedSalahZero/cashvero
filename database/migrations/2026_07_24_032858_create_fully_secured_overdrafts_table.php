...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fully_secured_overdrafts', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('cd_or_td_account_type_id')->nullable()->comment('هو هو حساب سي دي ولا تي دي ');
            $table->unsignedBigInteger('cd_or_td_account_id')->comment('الاي دي بتاع الحساب اللي اختارة وليكن 5');
            $table->decimal('cd_or_td_lending_percentage', 14, 5)->nullable()->default(0);
